...
if(is_not_logged_in() || !is_admin(get_logged_in_user()) ) {
    set_flash_message("danger", "Вы должны быть авторизованы под админом");
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="create_user_store.php" enctype="multipart/form-data" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="simpleinput" name="pass" class="form-control">
                                </div>
