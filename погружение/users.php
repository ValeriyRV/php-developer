    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">            
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo mb_strtolower($user['name']);?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="page_profile.php?id=<?php echo $user['id'];?>" class="fs-xl text-truncate text-truncate-lg text-info"><?php echo $user['name'];?></a>
                                    <?php
                                     if(is_admin(get_logged_in_user()) || is_equal_user($user, get_logged_in_user())):
                                    ?>
