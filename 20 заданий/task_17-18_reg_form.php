                        ...
                        <div class="panel-content">
                            <div class="panel-content">
                                <div class="form-group">
                                    ...
                                    <?endif;?>
                                    <form action="task_17-18_store.php" method="post">
                                        <div class="form-group">
                                        ...
                                        <a style="margin-left: 10px; margin-top: 15px;" class="btn btn-warning" href="task_17-18.php">Авторизация</a>
                                        </div>
